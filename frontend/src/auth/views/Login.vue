  ...
  <div class="auth-page">
    <div class="auth-card">
      ...
      <div class="auth-header">
        ...
        <p class="auth-sub">Sign in to your Planora account</p>
      </div>
      ...
      <form @submit.prevent="handleLogin" class="auth-form">
        ...
        <div class="field">
          ...
          <input id="password" type="password" v-model="password" required autocomplete="current-password" class="field-input" placeholder="••••••••" />
        </div>
